...
from DecodeHead import Pointnet2GMMPartSegHead

class get_model(nn.Module):
    def __init__(self, num_classes, normal_channel=False, class_weight=None):
...
# --------------------------------------------------------------------------------
        ...
        self.decodeHead = Pointnet2GMMPartSegHead(
    ...
    def forward(self, xyz, cls_label,gt_seg,eval=True):
        ...
        inputs = [x,l1_points,l2_points,l3_points]
        if eval:
